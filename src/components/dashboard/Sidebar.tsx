...
import {
  LayoutDashboard, FolderKanban, MessageSquare, FileText, BarChart3, ClipboardList, Settings, LogOut,
} from "lucide-react";
...
const links = [
  ...
  { href: "/dashboard/requests", label: "Service Requests", icon: ClipboardList },
